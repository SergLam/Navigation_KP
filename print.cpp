...
void MainWindow::Print(){
    ...
    QString b11 = "var map = new google.maps.Map(document.getElementById(\"map_canvas\"), myOptions); // Координаты для линии";
    ...
    // Замена координат на вычисленные
    ...
    // Обратно в массив строк
    b12=main_string;
    // ЗАПИСЬ В ФАЙЛ!
    ///////////////////// Сохранение в файл ////////////////////////
    QString FileSaving = QFileDialog::getSaveFileName(this,"Сохранить маршрут(Укажите путь и имя файла)","D:/","Файл html(*.html)");
    //qDebug()<<FileSaving;
